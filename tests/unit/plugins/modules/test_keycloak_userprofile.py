...
class TestKeycloakUserprofile(ModuleTestCase):
    ...
    def test_create_when_absent(self):
        ...
        with mock_good_connection():
            with patch_keycloak_api(get_components=return_value_get_components_get, create_component=return_value_component_create) as (mock_get_components, mock_get_component, mock_create_component, mock_update_component, mock_delete_component):
    ...
    def test_create_when_present(self):
        ...
        with mock_good_connection():
            with patch_keycloak_api(get_components=return_value_get_components_get, get_component=return_value_component_get,
                                    update_component=return_value_component_update) as (mock_get_components, mock_get_component, mock_create_component, mock_update_component, mock_delete_component):
                with self.assertRaises(AnsibleExitJson) as exec_info:
                    self.module.main()
    ...
    def test_delete_when_absent(self):
        ...
        with mock_good_connection():
            with patch_keycloak_api(get_components=return_value_get_components_get) as (mock_get_components, mock_get_component, mock_create_component, mock_update_component, mock_delete_component):
                with self.assertRaises(AnsibleExitJson) as exec_info:
                    self.module.main()
    ...
    def test_delete_when_present(self):
        ...
        with mock_good_connection():
            with patch_keycloak_api(get_components=return_value_get_components_get, delete_component=return_value_component_delete) as (mock_get_components, mock_get_component, mock_create_component, mock_update_component, mock_delete_component):
                with self.assertRaises(AnsibleExitJson) as exec_info:
                    self.module.main()
